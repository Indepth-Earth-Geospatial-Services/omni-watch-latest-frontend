...
const base =
  ...
  "whitespace-nowrap transition-[background,color] duration-200 ease-out " +
  "border border-transparent px-8 py-3";

const variants: Record<ButtonVariant, string> = {
  solid: "bg-btn hover:bg-btn-hover",
  // The `.btn-ghost` component class (globals.css) draws the blue corner brackets.
  ghost: "btn-ghost bg-transparent border-white/10 hover:bg-blue/[.06]",
};
