...
export const platformColumns: PlatformColumn[] = [
  {
    icons: ["/assets/icons/ic-incidents.png"],
  ...
  {
    icons: ["/assets/icons/ic-analysis-1.png", "/assets/icons/ic-analysis-2.png"],
    title: "AI Analysis",
  ...
  {
    icons: ["/assets/icons/ic-feed.png"],
    title: "Live Feed",
    beta: true,
