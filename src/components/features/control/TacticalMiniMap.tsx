    ...
    >
      ...
      <div className='absolute inset-0 z-10 pointer-events-none'>
        ...
        <div className='absolute right-4 top-1/2 -translate-y-1/2 flex flex-col items-center gap-2'>
          ...
          <span
            className={`text-[10px] font-logs font-bold ${isAirborne ? 'text-blue-400' : hasPosition ? 'text-muted-foreground' : 'text-muted-foreground'}`}
          >
          ...
          <div className='absolute bottom-10 right-4 flex flex-col gap-1.5'>
            {hasPosition && (
              <div className='flex items-center gap-1.5'>
                ...
                <span className='text-[8px] font-logs text-blue-400/70 uppercase tracking-wide'>
                  Drone
                </span>
              </div>
            )}
            {hasDockPos && (
              <div className='flex items-center gap-1.5'>
                ...
                <span className='text-[8px] font-logs text-emerald-400/70 uppercase tracking-wide'>
                  Dock
                </span>
              </div>
            )}
            {hasTarget && (
              <div className='flex items-center gap-1.5'>
                ...
                <span className='text-[8px] font-logs text-amber-400/70 uppercase tracking-wide'>
                  Target
                </span>
              </div>
            )}
