...
const incidents: Incident[] = [
  ...
  },
  {
    ...
    description: "Unusual vehicle convoy detected along Lagos-Ibadan highway with irregular movement patterns",
    status: "IN_PROGRESS",
    severity: "MEDIUM",
  ...
  },
  {
    ...
    description: "Unauthorized access detected at perimeter checkpoint with potential security implications",
    status: "ESCALATED",
    severity: "CRITICAL",
  ...
  },
  {
    ...
    description: "Potential infrastructure damage detected along pipeline corridor via thermal sensors",
    status: "OPEN",
    severity: "HIGH",
                          ...
                          <div className="flex items-start justify-between">
                            <div className="space-y-2">
                              <div className="flex items-center space-x-3">
                                ...
                                <span className={`text-xs ${getStatusColors(incident.status)} text-white px-2 py-1 rounded`}>
                                  {incident.status.replace('_', ' ')}
                                </span>
                                <span className={`text-xs ${getSeverityColors(incident.severity)} text-white px-2 py-1 rounded`}>
                                  {incident.severity}
                                </span>
                              </div>
