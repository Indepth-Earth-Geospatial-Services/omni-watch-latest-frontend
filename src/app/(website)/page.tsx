  ...
  return (
    <div className="bg-background text-foreground min-h-screen relative overflow-hidden">
      ...
      <section className="relative pt-40 pb-28 px-6">
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-12 leading-relaxed max-w-3xl mx-auto font-light">
              Real-time intelligence gathering, AI-powered threat detection, and comprehensive monitoring
        ...
        >
          <div className="absolute inset-0 border border-cyan-500/30 rounded-full animate-ping" style={{ animationDuration: '3s' }}></div>
          <div className="absolute inset-12 border border-cyan-500/30 rounded-full animate-ping" style={{ animationDuration: '2s', animationDelay: '0.5s' }}></div>
          <div className="absolute inset-24 border border-cyan-500/20 rounded-full animate-ping" style={{ animationDuration: '4s', animationDelay: '1s' }}></div>
        </div>
      </section>
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            <div className="inline-block px-4 py-1 bg-cyan-500/10 border border-cyan-500/30 rounded-full mb-6">
              <span className="text-sm font-mono text-cyan-400 uppercase tracking-wider">Core Systems</span>
            </div>
            ...
            {features.map((feature, index) => (
              <div
                ...
                className={`group relative bg-card/40 backdrop-blur-sm p-8 rounded-2xl border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-700 hover:shadow-2xl hover:shadow-cyan-500/10 transform-gpu perspective-1000 ${
                  visibleSections.has("features") ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-20 scale-95"
                }`}
                style={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div
                className={`transition-all duration-1000 ${
                  visibleSections.has("system-overview") ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"
                }`}
              >
                <div className="inline-block px-4 py-1 bg-cyan-500/10 border border-cyan-500/30 rounded-full mb-8">
                  <span className="text-sm font-mono text-cyan-400 uppercase tracking-wider">Command Hub</span>
                </div>
                <h2 className="text-5xl font-black mb-6 leading-tight">
                  <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Unified Control</span>
                  <br />
                ...
                <p className="text-xl text-gray-400 mb-10 leading-relaxed">
                  ...
                  managing threat responses, and maintaining situational awareness across all deployed assets.
                </p>
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={`flex items-start space-x-4 group transition-all duration-500 ${
                        visibleSections.has("system-overview") ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
                      }`}
                    ...
                    >
                      ...
                      <span className="text-gray-300 text-lg group-hover:text-cyan-400 transition-colors">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              >
                ...
                <div className="relative bg-card/50 backdrop-blur-sm p-8 rounded-2xl border border-cyan-500/20">
                  <div className="space-y-4">
                    {[
                      { icon: "fa-video", title: "Live Surveillance", desc: "Multi-camera monitoring", color: "cyan" },
                      { icon: "fa-shield-alt", title: "Threat Detection", desc: "AI-powered analysis", color: "red" },
                      { icon: "fa-chart-line", title: "Analytics Engine", desc: "Real-time insights", color: "green" },
                      { icon: "fa-users-cog", title: "Team Coordination", desc: "Secure access control", color: "purple" },
                    ].map((module, index) => (
                      <div
                        key={module.title}
                        className={`group relative flex items-center space-x-4 p-5 bg-card/80 backdrop-blur-sm rounded-xl border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-500 hover:translate-x-2 ${
                          visibleSections.has("system-overview") ? "opacity-100 scale-100" : "opacity-0 scale-95"
                        }`}
                        style={{ transitionDelay: `${600 + index * 100}ms` }}
                      >
                        <div className={`flex-shrink-0 w-14 h-14 rounded-lg bg-gradient-to-br from-${module.color}-500/10 to-${module.color}-500/5 flex items-center justify-center`}>
                          <i className={`fas ${module.icon} text-${module.color}-500 text-2xl`}></i>
                        </div>
                        <div className="flex-1">
                          <div className="font-bold text-gray-100 mb-1 group-hover:text-cyan-400 transition-colors">{module.title}</div>
            ...
            >
              ...
              <div className="relative text-center">
                ...
                >
                  ...
                  <span className="text-sm font-mono text-cyan-400 uppercase tracking-wider">Secure Access</span>
                </div>
                ...
                >
                  Join defense organizations and security professionals using SENTINEL for mission-critical surveillance operations
                </p>

                <div
                  className={`flex items-center justify-center gap-5 flex-wrap transition-all duration-700 delay-500 ${
                    visibleSections.has("cta-section") ? "opacity-100 scale-100" : "opacity-0 scale-90"
                  }`}
                >
                  <Link
                    href="/sign-up"
