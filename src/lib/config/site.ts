...
export const siteConfig = {
  name: "Omniwatch",
  title: "Omniwatch — Geospatial Asset Management for Enterprise",
  description:
    "Omniwatch is a unified geospatial ISR platform delivering real-time monitoring, threat detection, and operational intelligence across every critical asset you manage.",
