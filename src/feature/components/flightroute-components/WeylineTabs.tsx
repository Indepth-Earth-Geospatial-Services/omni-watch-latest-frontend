...
const WeylineTabs = ({ activeTab, onTabChange, onSearch }: WeylineTabsProps) => {
  ...
  return (
    <div className='flex items-center justify-between w-[calc(100%-2rem)] mx-4 h-[52px] px-3 bg-[#1A1C20] border border-zinc-800/50 rounded-xl font-poppins'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <button className='flex items-center gap-1.5 px-3 py-1.5 bg-[#1C93FF] text-white text-[11px] font-bold rounded-lg hover:bg-[#1C93FF]/80 transition-colors'>
